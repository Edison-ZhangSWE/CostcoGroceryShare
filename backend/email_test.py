...
SENDGRID_API_KEY = "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"
...
def render_email_content(product_name, orders):
    ...
    content = content.replace("[Recipient's Name]", "Customer")  # Replace this with actual user names if available
